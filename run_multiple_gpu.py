...
param_dict['--scale_forward_pred'] = [0,0.4]
param_dict['--manual_seed'] = list(range(10))
...
for param_idx, param in enumerate(t):
    search_element = ['/home/ebilgin/oasis_dfine/bin/python3',script_path,'--gpu_id',str(gpu_count%8)]
    gpu_count += 1
